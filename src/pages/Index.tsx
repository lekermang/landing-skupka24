...
const HERO_IMG = "https://cdn.poehali.dev/projects/8c10b732-2c19-482b-8e87-8dddcca34bde/bucket/c2eb5ee2-5948-4946-9e40-88d7c70b7960.jpg";
const PHOTO_IMG = "https://cdn.poehali.dev/projects/8c10b732-2c19-482b-8e87-8dddcca34bde/files/e785236f-12df-4407-8fa6-1bed345cf091.jpg";

const categories = [
  { label: "Техника Apple",    icon: "Apple" },
  { label: "Ноутбуки",         icon: "Laptop" },
  { label: "Смартфоны",        icon: "Smartphone" },
  { label: "Настольные ПК",    icon: "Monitor" },
  { label: "Мониторы",         icon: "MonitorSmartphone" },
  { label: "Игровые консоли",  icon: "Gamepad2" },
  { label: "Бытовая техника",  icon: "Refrigerator" },
  { label: "Антиквариат",      icon: "Clock" },
  { label: "Фарфор",           icon: "Coffee" },
  { label: "Ювелирные изделия",icon: "Gem" },
  { label: "Высокая оценка",   icon: "Search" },
  { label: "Покупаем дорого",  icon: "TrendingUp" },
];
...
const whyItems = [
  ...
  { icon: "Repeat",   title: "Любое состояние",             desc: "Принимаем со сломанным экраном и нерабочие устройства." },
];
  ...
  return (
    <div className="min-h-screen" style={{ background: "#111" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-40 transition-all duration-300"
        style={{
          background: scrolled ? "rgba(17,17,17,0.97)" : "rgba(17,17,17,0.5)",
      ...
      {/* ══════════════════════════════════════
          HERO — картинка как фон, точная копия
      ══════════════════════════════════════ */}
      <section id="home" className="relative w-full overflow-hidden">
        ...
        <div className="relative w-full">
          <img
            src={HERO_IMG}
            alt="Скупка24 — покупаем технику дороже всех"
            className="w-full h-auto block"
            style={{ minHeight: "60vh", objectFit: "cover" }}
          />
          {/* Кликабельные зоны поверх картинки — точно по позициям на фото */}
          <div className="absolute inset-0">
            {/* Верхний ряд подписей */}
            <button onClick={() => openModal("Техника Apple")}
              className="absolute cursor-pointer group" style={{ top: "2%", left: "5%", width: "18%", height: "18%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Техника Apple →</span>
              </div>
            </button>

            <button onClick={() => openModal("Ноутбуки")}
              className="absolute cursor-pointer group" style={{ top: "1%", left: "27%", width: "16%", height: "20%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Ноутбуки →</span>
              </div>
            </button>

            <button onClick={() => openModal("Смартфоны")}
              className="absolute cursor-pointer group" style={{ top: "1%", left: "47%", width: "18%", height: "20%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Смартфоны →</span>
              </div>
            </button>

            <button onClick={() => openModal("Настольные ПК")}
              className="absolute cursor-pointer group" style={{ top: "1%", left: "70%", width: "22%", height: "20%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Настольные ПК →</span>
              </div>
            </button>

            {/* Средний ряд подписей (под логотипом) */}
            <button onClick={() => openModal("Мониторы")}
              className="absolute cursor-pointer group" style={{ top: "52%", left: "0%", width: "16%", height: "18%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Мониторы →</span>
              </div>
            </button>

            <button onClick={() => openModal("Игровые консоли")}
              className="absolute cursor-pointer group" style={{ top: "48%", left: "22%", width: "20%", height: "22%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Игровые консоли →</span>
              </div>
            </button>

            <button onClick={() => openModal("Бытовая техника")}
              className="absolute cursor-pointer group" style={{ top: "48%", left: "46%", width: "20%", height: "22%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Бытовая техника →</span>
              </div>
            </button>

            <button onClick={() => openModal("Антиквариат")}
              className="absolute cursor-pointer group" style={{ top: "48%", left: "70%", width: "22%", height: "22%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Антиквариат →</span>
              </div>
            </button>

            {/* Нижний ряд */}
            <button onClick={() => openModal("Фарфор")}
              className="absolute cursor-pointer group" style={{ top: "76%", left: "0%", width: "16%", height: "20%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Фарфор →</span>
              </div>
            </button>

            <button onClick={() => openModal("Ювелирные изделия")}
              className="absolute cursor-pointer group" style={{ top: "76%", left: "20%", width: "16%", height: "20%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Ювелирные →</span>
              </div>
            </button>

            <button onClick={() => openModal("Высокая оценка")}
              className="absolute cursor-pointer group" style={{ top: "76%", left: "40%", width: "18%", height: "20%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Высокая оценка →</span>
              </div>
            </button>

            <button onClick={() => openModal("Покупаем дорого")}
              className="absolute cursor-pointer group" style={{ top: "76%", left: "60%", width: "18%", height: "20%" }}>
              <div className="w-full h-full rounded-2xl transition-all group-hover:bg-white/15 group-hover:backdrop-blur-sm group-hover:scale-105 flex items-end justify-center pb-1">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs sm:text-sm font-black px-2 py-1 rounded-lg"
                  style={{ background: "#FFD700", color: "#111" }}>Продать →</span>
              </div>
            </button>

            {/* Центр — кнопка заявки */}
            <button onClick={() => openModal()}
              className="absolute cursor-pointer group" style={{ top: "25%", left: "20%", width: "60%", height: "22%" }}>
              <div className="w-full h-full rounded-3xl transition-all group-hover:bg-black/10 group-hover:backdrop-blur-[2px] flex items-center justify-center">
                <span className="opacity-0 group-hover:opacity-100 transition-all scale-90 group-hover:scale-100 text-lg sm:text-2xl font-black px-6 py-3 rounded-2xl shadow-xl"
                  style={{ background: "#FFD700", color: "#111" }}>
                  ⚡ Оставить заявку
                </span>
              </div>
        ...
        {/* CTA панель под картинкой */}
        <div className="w-full py-5 px-4 flex flex-col sm:flex-row gap-3 justify-center items-center"
          style={{ background: "#1A1A1A", borderBottom: "3px solid #FFD700" }}>
          <button onClick={() => openModal()}
            className="font-black px-8 py-3 rounded-2xl text-base flex items-center gap-2 transition-all hover:scale-105 animate-pulse-gold"
          ...
          <a href={`tel:${PHONE_MAIN}`}
            ...
            <Icon name="Phone" size={16} /> {PHONE_MAIN}
          </a>
        </div>
      </section>

      {/* ── БЕГУЩАЯ СТРОКА ── */}
      <div className="overflow-hidden py-3" style={{ background: "#111", borderBottom: "3px solid #FFD700" }}>
            ...
            <span key={r} className="inline-flex gap-8 pr-8">
              {["🍎 Техника Apple","💻 Ноутбуки","📱 Смартфоны","🎮 Консоли","🏺 Антиквариат","💎 Ювелирка","🫖 Фарфор","🖥️ Мониторы","📷 Фото","⌚ Часы","🏠 Бытовая техника","💰 Покупаем дорого"].map((t, i) => (
                <span key={i} className="font-bold text-sm whitespace-nowrap" style={{ color: "#FFD700" }}>
                  {t} <span style={{ color: "rgba(255,215,0,0.25)" }}> ◆ </span>
                </span>
              ))}
            </span>
          ))}
      ...
      <section id="categories" className="py-16 px-4" style={{ background: "#0D0D0D" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-white/45 text-sm">Нажмите — мгновенно оставите заявку</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {categories.map((cat, i) => (
              <button key={i} onClick={() => openModal(cat.label)}
                ...
                <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-3 transition-transform group-hover:scale-110"
                  ...
                  <Icon name={cat.icon} size={20} className="text-yellow-400" />
                </div>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="rounded-3xl overflow-hidden" style={{ border: "3px solid #FFD700" }}>
              <img src={PHOTO_IMG} alt="Скупка24 Apple техника" className="w-full object-cover" style={{ maxHeight: "420px" }} />
            </div>
      ...
      <section className="py-20 px-4 circuit-bg relative overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="font-semibold mb-10" style={{ color: "rgba(0,0,0,0.55)", fontSize: "clamp(16px,2.5vw,20px)" }}>
